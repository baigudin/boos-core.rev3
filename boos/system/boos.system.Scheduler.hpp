 ...
 */
#ifndef BOOS_SYSTEM_SCHEDULER_HPP_
#define BOOS_SYSTEM_SCHEDULER_HPP_
...
namespace system
{
  ...
  public:
    ...
    virtual void main()
    {
      ...
      while(true)
      {
        ...
        switch(task->status_)
        {
          ...
          case Task::SLEEPING: 
          {
            if(System::nanoTime() >= task->sleep_)
            {
              task->sleep_ = 0;
              task->status_ = Task::RUNNABLE;
            }
    ...
    void sleep(int64 millis, int64 nanos)
    {
      ...
      task->sleep_ = System::nanoTime() + millis * 1000000 + nanos;
      jump();
      global_.enable(is);    
    }
...
#endif // BOOS_SYSTEM_SCHEDULER_HPP_
