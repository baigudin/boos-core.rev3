...
namespace utility
{
    ...
    public:
         ...
         *
         * @param dst pointer to the destination array where 
        ...
        {
            register cell* sp = 
                static_cast<cell*>(const_cast<void*>(src));
            register cell* dp = 
         ...
         *            of memory to fill.
         * @param val value to be set. The value is passed as an int, 
         *            but the function fills the block of memory 
         *            using the unsigned char conversion 
         *            of this value.
         ...
         *
         * @param dst pointer to the destination array, which should 
         *            contain a C string, 
         *            and be large enough to contain the concatenated 
         *            resulting string.
         * @param src C-string to be appended. This should not 
         *            overlap destination.
         * @return destination is returned.     
         */
         ...
         * @return a value indicating the relationship 
         *         between the strings.
         */
