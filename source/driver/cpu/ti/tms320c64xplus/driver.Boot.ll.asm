...
; -------------------------------------------------------------------
    ...
    ; Set a using ABI which might be EABI if EABI is set to 1, or 
    ; COFF ABI if EABI is set to 0. Having version 7.0 or greater 
    ; C6000 compilers might generate object files compatible 
