 ...
 */
#ifndef BOOS_SYSTEM_THREAD_HPP_
#define BOOS_SYSTEM_THREAD_HPP_

#include "boos.system.ThreadTask.hpp"
...
namespace system
{
  ...
  public:
     ...
     */
    static ::system::Thread& currentThread();
